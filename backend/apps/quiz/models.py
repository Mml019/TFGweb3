...
class Dimension(models.Model):
    idD =       models.PositiveSmallIntegerField(primary_key=True)
...
class Question(models.Model): 
    ...
    idP =               models.PositiveBigIntegerField(primary_key=True)
...
class Satisfation(models.Model):
    ...
    idSas =     models.PositiveBigIntegerField(primary_key=True)
...
class Enviroment(models.Model):
    idEnv = models.PositiveIntegerField(primary_key=True)
...
class Sector(models.Model):
    idSec = models.PositiveIntegerField(primary_key=True)
...
class Activity(models.Model):
    idAct = models.PositiveIntegerField(primary_key=True)
