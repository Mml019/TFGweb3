...
export default function UserForm() {
  ...
  const descriptions = [
    ...
    {
      label:
        "Oficial (de 60-120 ECTS con trabajo de investigación que habilita el acceso al doctorado)",
      type: "Oficial",
    },
    {
      label:
        "No oficial pero que incluya créditos relacionados con investigación, estadística…",
      type: "No oficial con créditos en investigación",
    },
    {
      label: "No oficiales, exclusivamente profesionalizantes",
      type: "No oficial, profesionalizante",
    },
  ];
